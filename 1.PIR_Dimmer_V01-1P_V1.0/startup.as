	...
	; Compiler options:
	;
	; -oPIR_Dimmer_V01-1P_V1.0.cof -mPIR_Dimmer_V01-1P_V1.0.map \
	; --summary=default --output=default Buzzer.p1 Dimmer.p1 LED.p1 \
	; MCU_16F723A.p1 PIR_Dimmer_V01-1P_V1.0.p1 Sensor_PIR+CDS.p1 Timer1.p1 \
	; --chip=16F723A -P --runtime=default --opt=default -D__DEBUG=1 -g \
