...
#ifndef _OverLoad_A_H_
#define _OverLoad_A_H_
...
//NOP
		...
		#ifndef Load_ERROR_Main()
			#define Load_ERROR_Main() NOP()
		#endif

		#ifndef setLoad_ADHADL_Restore_Main()
			#define setLoad_ADHADL_Restore_Main() NOP()
		#endif

		#ifndef setLoad_Hold(command)
