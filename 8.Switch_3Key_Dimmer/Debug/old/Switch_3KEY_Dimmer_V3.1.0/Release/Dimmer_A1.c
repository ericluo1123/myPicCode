...
{
	setDimmerLights1_ERROR_Main();
}

void setDimmerLights2_ERROR()
{
	setDimmerLights2_ERROR_Main();
}

void setDimmerLights3_ERROR()
{
	setDimmerLights3_ERROR_Main();
}

void Dimmer_setOverLoad_GO_Off()
{
	//Dimmer_setOverLoad_GO_Off_Main();
}
