...
***********************************************************/
		...
		struct DimmerLights
		{
			...
			#define getDimmerLights1_Status DimmerLights1->Status
	...
	//		#define Dimmer_setOverLoad_GO_Off_Main() Dimmer_setOverLoad_GO_Off_3()
			...
			#define getDimmerLights2_Status DimmerLights2->Status
	...
	//		#define Dimmer_setOverLoad_GO_Off_Main() Dimmer_setOverLoad_GO_Off_3()
			...
			#define getDimmerLights3_Status DimmerLights3->Status
	...
	#define Dimmer_Close_1()\
				if(getDimmerLights1_Status == 0 && getDimmerLights2_Status == 0 && getDimmerLights3_Status == 0)\
				{\
					setMemory_GO(1);\
				}\
	...
	#define Dimmer_ERROR_1()\
				...
				{\
					if(getDimmerLights1_Status || getDimmerLights2_Status || getDimmerLights3_Status)\
					{\
						setBuzzer(10,300);\
					}\
