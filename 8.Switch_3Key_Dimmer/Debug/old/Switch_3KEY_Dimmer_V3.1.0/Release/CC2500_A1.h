...
#define DEFINE_H
		...
		#define DelayTime_1us_Main() DelayTime_1us_Main_1()
			
		#define CC2500_ReadStatus_Main() CC2500_ReadStatus_Main_1()	

		#define CC2500_WriteCommand_Main() CC2500_WriteCommand_Main_1()
	
		#define CC2500_ReadREG_Main() CC2500_ReadREG_Main_1()

		#define CC2500_WriteREG_Main() CC2500_WriteREG_Main_1()

		#define CC2500_ReadByte_Main() CC2500_ReadByte_Main_1()
	
		#define CC2500_WriteByte_Main() CC2500_WriteByte_Main_1()

		#define CC2500_SIDLEMode_Main() CC2500_SIDLEMode_Main_1()

		#define CC2500_FrequencyCabr_Main() CC2500_FrequencyCabr_Main_1()

		#define CC2500_ClearRXFIFO_Main() CC2500_ClearRXFIFO_Main_1()

		#define CC2500_ClearTXFIFO_Main() CC2500_ClearTXFIFO_Main_1()

		#define CC2500_InitPATable_Main() CC2500_InitPATable_Main_1()

		#define CC2500_InitSetREG_Main() CC2500_InitSetREG_Main_1()

		#define CC2500_PowerRST_Main() CC2500_PowerRST_Main_1()

		#define CC2500_PowerOnInitial_Main() CC2500_PowerOnInitial_Main_1()

		#define CC2500_RxData_Main() CC2500_RxData_Main_1()

		#define CC2500_TxData_Main() CC2500_TxData_Main_1()
	#endif 


	//NOP
	#ifndef DelayTime_1us_Main()
		#define DelayTime_1us_Main() NOP()
	#endif	

	#ifndef CC2500_ReadStatus_Main()
		#define CC2500_ReadStatus_Main() NOP()
	#endif	

	#ifndef CC2500_WriteCommand_Main()
		#define CC2500_WriteCommand_Main() NOP()
	#endif	

	#ifndef CC2500_ReadREG_Main()
		#define CC2500_ReadREG_Main() NOP()
	#endif	

	#ifndef CC2500_WriteREG_Main()
		#define CC2500_WriteREG_Main() NOP()
	#endif	

	#ifndef CC2500_ReadByte_Main()
		#define CC2500_ReadByte_Main() NOP()
	#endif	

	#ifndef CC2500_WriteByte_Main()
		#define CC2500_WriteByte_Main() NOP()
	#endif	

	#ifndef CC2500_SIDLEMode_Main()
		#define CC2500_SIDLEMode_Main() NOP()
	#endif

	#ifndef CC2500_FrequencyCabr_Main()
		#define CC2500_FrequencyCabr_Main() NOP()
	#endif	

	#ifndef CC2500_ClearRXFIFO_Main()
		#define CC2500_ClearRXFIFO_Main() NOP()
	#endif	

	#ifndef CC2500_ClearTXFIFO_Main()
		#define CC2500_ClearTXFIFO_Main() NOP()
	#endif

	#ifndef CC2500_InitPATable_Main()
		#define CC2500_InitPATable_Main() NOP()
	#endif

	#ifndef CC2500_InitSetREG_Main()
		#define CC2500_InitSetREG_Main() NOP()
	#endif

	#ifndef CC2500_PowerRST_Main()
		#define CC2500_PowerRST_Main() NOP()
	#endif

	#ifndef CC2500_PowerOnInitial_Main()
		#define CC2500_PowerOnInitial_Main() NOP()
	#endif

	#ifndef CC2500_RxData_Main()
		#define CC2500_RxData_Main() NOP()
	#endif

	#ifndef CC2500_TxData_Main()
		#define CC2500_TxData_Main() NOP()
	#endif
	...
	//RxData
	#define CC2500_RxData_Main_1()\
				;\//CC2500_WriteCommand(CC2500_SRX);  		// set receive mode
				;\//while(CC2500_GDO0==0);            		// wait for data 
				if(CC2500_GDO0)								\// Check whether have data
				{\
					while(CC2500_GDO0);			 			\// wait for receive complete	  		 
				}\
	...
	//PowerOnInitial
	#define CC2500_PowerOnInitial_Main_1()\
	...
	//InitSetREG
	#define CC2500_InitSetREG_Main_1()\
	...
	//InitPATable
	#define CC2500_InitPATable_Main_1()\
	...
	//ClearTXFIFO
	#define CC2500_ClearTXFIFO_Main_1()\
				CC2500_WriteCommand(CC2500_SFTX);\
				;

	//ClearRXFIFO
	#define CC2500_ClearRXFIFO_Main_1()\
				CC2500_WriteCommand(CC2500_SFRX);\
				;

	//FrequencyCabr
	#define CC2500_FrequencyCabr_Main_1()\
			    CC2500_WriteCommand(CC2500_SCAL);\
				DelayTime_1us(1000);\
				;

	//SIDLEMode
	#define CC2500_SIDLEMode_Main_1()\
				CC2500_WriteCommand(CC2500_SIDLE);\
				;
	//WriteByte	
	#define CC2500_WriteByte_Main_1()\
	...
	//WriteCommand
	#define CC2500_WriteCommand_Main_1()\
			    CC2500_CSN=0;\
				SPI0Buffer=command;\
				while(CC2500_SO==1);\
				CC2500_WriteByte();\
	...
	//ReadStatus
	#define CC2500_ReadStatus_Main_1()\
			    CC2500_CSN=0;\
