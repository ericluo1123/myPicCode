...
//PLLEN = 0
 	...
 	#define	OSCCON_Value	0x30
  	#define FOSC	500000
  #endif 

  #ifdef System_Fosc_250K
 	 #define	OSCCON_Value	0x20
 	 #define FOSC	250000
  #endif

  #ifdef System_Fosc_125K
 	 #define	OSCCON_Value	0x10
	 #define FOSC	125000
  #endif

  #ifdef System_Fosc_62.5K	
 	 #define	OSCCON_Value	0x00
 	 #define FOSC	62500
  #endif
