	...
	; Compiler options:
	;
	; -oPIR_Ceiling_Dimmer_NO_Triac_Bridge_(20140517).cof \
	; -mPIR_Ceiling_Dimmer_NO_Triac_Bridge_(20140517).map --summary=default \
	; --output=default Main.p1 --chip=16F723A -P --runtime=default \
