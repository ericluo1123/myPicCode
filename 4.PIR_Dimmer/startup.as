	...
	; Compiler options:
	;
	; -oPIR_Dimmer.cof -mPIR_Dimmer.map --summary=default --output=default \
	; PIR-Ceiling-PV02-3(20140517).p1 --chip=16F723A \
	; -IH:\Program\PIC\Header_File -IG:\Program\PIC\Header_File \
	; -IG:\Program\PIC\4.PIR_Dimmer\Release \
	; -IG:\Program\PIC\Header_File\4.PIR_Dimmer \
