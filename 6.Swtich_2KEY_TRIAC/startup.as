	...
	; Compiler options:
	;
	; -oSwitch_2KEY_TRIAC_V1.0.cof -mSwitch_2KEY_TRIAC_V1.0.map \
	; --summary=default --output=default OverLoad_A.p1 MCU_16f1516_A.p1 \
	; Buzzer_A1.p1 CC2500_A1.p1 RF_Control_A1.p1 LED_A1.p1 Dimmer_A1.p1 \
	; main.p1 --chip=16F1516 -IG:\Program\PIC\Header_File \
	; -IG:\Program\PIC\6.Swtich_2KEY_TRIAC\Relese -P --runtime=default \
