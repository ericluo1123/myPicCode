...
//SmartRF Conversion CC2500 registers data
    ...
    0x56,   //21* FREND1    Front end RX configuration.
    0x10,   //22* FREND0    Front end RX configuration.
    0x18,   //23* MCSM0     Main Radio Control State Machine configuration.
    0x16,   //24* FOCCFG    Frequency Offset Compensation Configuration.
    0x6C,   //25* BSCFG     Bit synchronization Configuration.
    0x03,   //26* AGCCTRL2  AGC control.
    0x40,   //27* AGCCTRL1  AGC control.
    0x91,   //28* AGCCTRL0  AGC control.
    0xA9,   //29* FSCAL3    Frequency synthesizer calibration.
    ...
    0x04,   //41* PKTCTRL0  Packet automation control.
