...
/***Define***/
  //Percent set
		...
		#define FortyFive_Percent	((int)(55*One_Percent))		//30% (70 *One_Percent)	
	  	#define Forty_Percent		((int)(60*One_Percent))		//30% (70 *One_Percent)	
	...
	#define Dimmer_Medium	FortyFive_Percent
