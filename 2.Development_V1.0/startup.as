	...
	; Compiler options:
	;
	; -oDevelopment_V1.0.cof -mDevelopment_V1.0.map --summary=default \
	; --output=default MCU_16f1516.p1 SegmentDisplay.p1 Touch.p1 Usart.p1 \
	; I2C.p1 Development_V1.0.p1 --chip=16F1516 \
	; -IG:\Program\PIC\Header_File \
	; -IG:\Program\PIC\Header_File\2.Development_V1.0 \
	; -IH:\Program\PIC\Header_File -P --runtime=default --opt=default \
