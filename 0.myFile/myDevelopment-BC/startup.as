	...
	; Compiler options:
	;
	; -omyDevelopment-BC.cof -mmyDevelopment-BC.map --summary=default \
	; --output=default CC2500_B1.p1 RF_Control_B1.p1 SegmentDisplay_A2.p1 \
	; myMain.p1 MCU_16f1516_B1.p1 --chip=16F1516 \
	; -IG:\Program\PIC\0.myFile\myDevelopment-BH\Release \
