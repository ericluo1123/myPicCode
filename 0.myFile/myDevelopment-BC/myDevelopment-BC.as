...
__pidataBANK1:
	file	"G:\Program\PIC\0.myFile\myDevelopment-BH\Release\../Release/myDevelopment-B.h"
	line	230
...
;; Defined at:
;;		line 177 in file "G:\Program\PIC\Source_File\RF_Control_B1.c"
;; Parameters:    Size  Location     Type
...
;; Defined at:
;;		line 195 in file "G:\Program\PIC\Source_File\RF_Control_B1.c"
;; Parameters:    Size  Location     Type
;;  rf              1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
...
;MCU_16f1516_B1.c: 283: I2C->SlaveGO=0;
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
l8593:	
;MCU_16f1516_B1.c: 284: I2C_Slave_Mode();
	fcall	_I2C_Slave_Mode
	line	285
	
l8595:	
;MCU_16f1516_B1.c: 285: SSPIE=1;
	movlb 1	; select bank1
	bsf	(1163/8)^080h,(1163)&7
	line	287
	
l8597:	
;MCU_16f1516_B1.c: 287: if(I2C->SlaveTxGO)
	movlb 0	; select bank0
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
...
l8599:	
;MCU_16f1516_B1.c: 288: {
;MCU_16f1516_B1.c: 289: I2C->SlaveTxGO=0;
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
l8601:	
;MCU_16f1516_B1.c: 290: RC0=0;
	bcf	(112/8),(112)&7
	line	291
;MCU_16f1516_B1.c: 291: I2C->SS=0;
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
;MCU_16f1516_B1.c: 293: if(I2C->SlaveRxGO)
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
l8603:	
;MCU_16f1516_B1.c: 294: {
;MCU_16f1516_B1.c: 295: I2C->SlaveRxGO=0;
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
l8605:	
;MCU_16f1516_B1.c: 296: I2C_SetData(0);
	movlw	(0)
	fcall	_I2C_SetData
	goto	l8607
	line	297
...
l8607:	
;MCU_16f1516_B1.c: 297: }
;MCU_16f1516_B1.c: 298: RA1=~RA1;
	movlw	1<<((97)&7)
	movlb 0	; select bank0
	xorwf	((97)/8),f
	goto	l5596
...
;; Defined at:
;;		line 454 in file "G:\Program\PIC\Source_File\MCU_16f1516_B1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l8489:	
;MCU_16f1516_B1.c: 455: char i;
;MCU_16f1516_B1.c: 456: SSPIF=0;
	movlb 0	; select bank0
	bcf	(139/8),(139)&7
	line	457
	
l8491:	
;MCU_16f1516_B1.c: 457: I2C->Address=SSPBUF;
...
l8495:	
;MCU_16f1516_B1.c: 460: {
;MCU_16f1516_B1.c: 461: SSPOV=0;
	bcf	(4270/8)^0200h,(4270)&7
	line	462
;MCU_16f1516_B1.c: 462: for(i=0;i<5;i++)
	movlb 0	; select bank0
...
;MCU_16f1516_B1.c: 464: SSPBUF=I2C->BufferWriter[i];
...
l8503:	
;MCU_16f1516_B1.c: 466: CKP=1;
	bsf	(4268/8)^0200h,(4268)&7
	line	467
;MCU_16f1516_B1.c: 467: while(!SSPIF);
	goto	l5694
...
l5696:	
	line	468
;MCU_16f1516_B1.c: 468: SSPIF=0;
	bcf	(139/8),(139)&7
	line	469
;MCU_16f1516_B1.c: 469: while(ACKSTAT);
	goto	l5697
...
;MCU_16f1516_B1.c: 471: CKP=1;
	movlb 4	; select bank4
	bsf	(4268/8)^0200h,(4268)&7
	line	473
	
l8509:	
;MCU_16f1516_B1.c: 473: I2C->SlaveTxGO=1;
	movlb 0	; select bank0
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
...
l5691:	
	line	477
;MCU_16f1516_B1.c: 475: else
;MCU_16f1516_B1.c: 476: {
;MCU_16f1516_B1.c: 477: CKP=1;
	bsf	(4268/8)^0200h,(4268)&7
	line	478
;MCU_16f1516_B1.c: 478: for(i=0;i<32;i++)
	movlb 0	; select bank0
	clrf	(I2C_Slave_Mode@i)
...
l5701:	
	line	480
;MCU_16f1516_B1.c: 479: {
;MCU_16f1516_B1.c: 480: while(!SSPIF);
	goto	l5703
...
l5705:	
	line	481
;MCU_16f1516_B1.c: 481: SSPIF=0;
	bcf	(139/8),(139)&7
	line	482
	
l8515:	
;MCU_16f1516_B1.c: 482: I2C->BufferReader[i]=SSPBUF;
	movlb 4	; select bank4
	movf	(529)^0200h,w	;volatile
	movlb 0	; select bank0
	movwf	(??_I2C_Slave_Mode+0)+0
...
l8523:	
;MCU_16f1516_B1.c: 485: }
;MCU_16f1516_B1.c: 487: I2C->SlaveRxGO=1;
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
;; *************** function _INT_Set *****************
;; Defined at:
;;		line 149 in file "G:\Program\PIC\Source_File\MCU_16f1516_B1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _setINT_GO *****************
;; Defined at:
;;		line 167 in file "G:\Program\PIC\Source_File\MCU_16f1516_B1.c"
;; Parameters:    Size  Location     Type
;;  command         1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
...
;; Defined at:
;;		line 346 in file "G:\Program\PIC\Source_File\MCU_16f1516_B1.c"
;; Parameters:    Size  Location     Type
;;  command         1    wreg     unsigned char 
;; Auto vars:     Size  Location     Type
;;  command         1    2[BANK0 ] unsigned char 
...
l8293:	
;MCU_16f1516_B1.c: 348: char i;
;MCU_16f1516_B1.c: 349: if(command)
...
;MCU_16f1516_B1.c: 351: if(!I2C->SS)
	movf	(_I2C),w
	addlw	042h
	movwf	fsr1l
	movlw 1	; select bank2/3
...
l8299:	
;MCU_16f1516_B1.c: 354: for(i=0 ;i< 21 ;i++)
	clrf	(I2C_SetData@i)
...
;MCU_16f1516_B1.c: 356: I2C->BufferWriter[i]=RF_Data[i];
...
l8311:	
;MCU_16f1516_B1.c: 357: }
;MCU_16f1516_B1.c: 358: I2C->BufferWriter[21]=Tx_Length;
	movf	(_Tx_Length),w
	movwf	(??_I2C_SetData+0)+0
	movf	(_I2C),w
	addlw	035h
	...
	movwf	indf1
	line	359
;MCU_16f1516_B1.c: 359: I2C->BufferWriter[22]=RSSI;
	movf	(_RSSI),w
	movwf	(??_I2C_SetData+0)+0
	movf	(_I2C),w
	addlw	036h
	...
	movwf	indf1
	line	360
;MCU_16f1516_B1.c: 360: I2C->BufferWriter[23]=CRC;
	movf	(_CRC),w
	movwf	(??_I2C_SetData+0)+0
	movf	(_I2C),w
	addlw	037h
...
l5599:	
	line	366
;MCU_16f1516_B1.c: 364: else
;MCU_16f1516_B1.c: 365: {
;MCU_16f1516_B1.c: 366: for(i=0;i<21;i++)
	clrf	(I2C_SetData@i)
...
;MCU_16f1516_B1.c: 368: RF_Data[i]=I2C->BufferReader[i];
	movf	(I2C_SetData@i),w
	addwf	(_I2C),w
	movwf	(??_I2C_SetData+0)+0
...
l8325:	
;MCU_16f1516_B1.c: 369: }
;MCU_16f1516_B1.c: 371: RF->TransceiveGO=1;
	movf	(_RF),w
	movwf	fsr1l
	clrf fsr1h	
...
;; *************** function _INT_ISR *****************
;; Defined at:
;;		line 157 in file "G:\Program\PIC\Source_File\MCU_16f1516_B1.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
