	...
	; Compiler options:
	;
	; -oSwitch_2Key_Dimmer_V2.1.0.cof -mSwitch_2Key_Dimmer_V2.1.0.map \
	; --summary=default --output=default main.p1 Switch_B1.p1 Buzzer_B1.p1 \
	; CC2500_B1.p1 DelayOff_B1.p1 LED_B1.p1 RF_Control_B1.p1 \
	; MCU_16f1518_B1.p1 PowerFault_B1.p1 OverTemperature_B1.p1 \
	; OverLoad_B1.p1 Dimmer_B1.p1 --chip=16F1518 \
	; -IG:\Program\PIC\9.Switch_2Key_Dimmer\Switch_2Key_Dimmer_V2.1.0\Release \
	; -IG:\Program\PIC\Header_File -P --runtime=default --opt=default \
