	...
	; Compiler options:
	;
	; -oSwitch_1Key_Dimmer_V1.2.1.1.1.cof \
	; -mSwitch_1Key_Dimmer_V1.2.1.1.1.map --summary=default \
	...
	; -IC:\Users\taianluo\Documents\GitHub\myPicCode\10.Switch_1Key_Dimmer\Release\Switch_1Key_Dimmer_V1.2.1.1.1\Release \
	; -P --runtime=default --opt=default -N-1 -g --asmlist \
...
;Stack space: 02187h-0231Fh (409 bytes)
